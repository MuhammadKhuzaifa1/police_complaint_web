...
class RejectComplaints extends StatefulWidget {
  const RejectComplaints({super.key});

  @override
  State<RejectComplaints> createState() => _RejectComplaintsState();
}

class _RejectComplaintsState extends State<RejectComplaints> {
  @override
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text("Rejected Complaints", style: AppTextStyle.normalTextStyle()),
              ],
            ),
                ...
                child: Container(
                    ...
                    child: Padding(
                        ...
                        child: StreamBuilder<QuerySnapshot>(
                          ...
                          where('status',isEqualTo: 'reject').snapshots(),
