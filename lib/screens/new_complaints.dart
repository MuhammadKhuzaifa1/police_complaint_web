...
class NewComplaints extends StatefulWidget {
  const NewComplaints({super.key});

  @override
  State<NewComplaints> createState() => _NewComplaintsState();
}

class _NewComplaintsState extends State<NewComplaints> {
  @override
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text("New Complaints", style: AppTextStyle.normalTextStyle()),
              ],
            ),
              ...
              child: Container(
                ...
                child: Padding(
                    ...
                    child: StreamBuilder<QuerySnapshot>(
                      ...
                      where('status',isEqualTo: 'processing').snapshots(),
